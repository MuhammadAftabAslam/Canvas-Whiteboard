...
if($microphoneLevel[0].valueAsNumber){
  var level = $microphoneLevel[0].valueAsNumber / 100;
  microphoneLevel.gain.value = level * level;
}

$("#microphoneSound").click(function(){
  if($("#microphoneSound").hasClass('mute')){
    $("#microphoneSound").removeClass('mute')
     var level = $microphoneLevel[0].valueAsNumber / 100;
    microphoneLevel.gain.value = level * level;
  }
  else{
    $("#microphoneSound").addClass('mute')
     var level = 0 / 100;
    microphoneLevel.gain.value = level * level;
  }
});